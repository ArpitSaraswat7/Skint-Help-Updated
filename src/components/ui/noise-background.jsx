...
export const NoiseBackground = ({
    ...
    containerClassName,
    gradientColors = [
        "rgb(246, 206, 113)", // Warm gold - primary
        "rgb(150, 180, 150)", // Muted sage - secondary
        "rgb(180, 200, 180)", // Light sage accent
    ],
    noiseIntensity = 0.2,
    speed = 0.1,
    backdropBlur = false,
    ...
    return (
        <div
            ref={containerRef}
            className={cn(
                "group relative overflow-hidden rounded-xl bg-neutral-200/10 backdrop-blur-sm dark:bg-neutral-800/10",
                "shadow-[0px_0.5px_1px_0px_rgba(255,255,255,0.1)_inset,0px_1px_0px_0px_rgba(0,0,0,0.3)]",
                backdropBlur &&
        ...
        >
            ...
            {/* Top gradient strip */}
            <motion.div
                className="absolute inset-x-0 top-0 h-1 rounded-t-xl opacity-80 blur-sm"
                style={{
